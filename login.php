...
<body>
	...
	<div class="login_box">
		...
		<div class="auto_log">
			<input type="checkbox" id="chk_auto"><label for="chk_auto"><em>自动登录</em></label><input type="checkbox" 
			id="chk_safe"><label for="chk_safe"><em>安全控件登录</em></label><a href="#">忘记密码？</a>
		</div>
		<div class="login_btn">
		...
		<div class="coop">
			<h4>使用合作网站帐号登陆：</h4>
			<a href="#">QQ</a>|<a href="#">网易</a>|<a href="#">人人</a>|<a href="#">奇虎360</a>|<a href="#">开心</a>
			|<a href="#">豆瓣</a>|<a href="#">搜狐</a>|<a href="#" class="more">更多</a>
		</div>
		<a href="#" class="free_reg">免费注册&gt&gt</a>
	</div>
	<div class="bottomInfo">
		<div class="mooke_info">
			<a href="#">慕课简介</a>|<a href="#">慕课公告</a>|<a href="#">招贤纳士</a>|<a href="#">联系我们</a>|<a 
			href="#">客服热线： 400-675-1234</a>
		</div>
